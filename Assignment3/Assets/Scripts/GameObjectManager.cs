...
public class GameObjectManager : MonoBehaviour
{
    ...
    {
        PlayerObject p = new PlayerObject(Random.Range(0, 1000),pName[Random.Range(0, pName.Length)], dName[Random.Range(0, dName.Length)], Random.Range(0.0f, 10.0f), new Vector3(Random.Range(0, 9), Random.Range(0, 9), Random.Range(0, 9)));
