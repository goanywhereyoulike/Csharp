...
public class GameController_Script : MonoBehaviour 
{
    ...
    //Public Var
   // public StaticDataManager GameManager;
	...
	IEnumerator enemyBlueSpawnWaves()
	{
        ...
        enemyBlue.Count = StaticDataManager.curGame.Enemycount;
        //Infinite Loop
        while (true)
		{
			//Spawn Specific number of Objects in 1 wave
	...
	IEnumerator enemyGreenSpawnWaves()
	{
        ...
        enemyGreen.Count = StaticDataManager.curGame.Enemycount;
        //Infinite Loop
        while (true)
		{
			//Spawn Specific number of Objects in 1 wave
	...
	IEnumerator enemyRedSpawnWaves()
	{
        ...
        enemyRed.Count = StaticDataManager.curGame.Enemycount;
        //Infinite Loop
        while (true)
		{
			//Spawn Specific number of Objects in 1 wave
